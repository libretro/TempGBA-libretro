  ...
  {                                                                           \
    ...
    {                                                                         \
      ...
      dma0->start_type = (value >> 12) & 0x03;                                \
                                                                              \
      dma0->source_address = ADDRESS32(io_registers, 0xB0) & 0x07FFFFFF;      \
      dma0->dest_address   = ADDRESS32(io_registers, 0xB4) & 0x07FFFFFF;      \
                                                                              \
  ...
  {                                                                           \
    ...
    {                                                                         \
      ...
      dma1->start_type = (value >> 12) & 0x03;                                \
                                                                              \
      dma1->source_address = ADDRESS32(io_registers, 0xBC) & 0x0FFFFFFF;      \
      dma1->dest_address   = ADDRESS32(io_registers, 0xC0) & 0x07FFFFFF;      \
                                                                              \
  ...
  {                                                                           \
    ...
    {                                                                         \
      ...
      dma2->start_type = (value >> 12) & 0x03;                                \
                                                                              \
      dma2->source_address = ADDRESS32(io_registers, 0xC8) & 0x0FFFFFFF;      \
      dma2->dest_address   = ADDRESS32(io_registers, 0xCC) & 0x07FFFFFF;      \
                                                                              \
  ...
  {                                                                           \
    ...
    {                                                                         \
      ...
      dma3->start_type = (value >> 12) & 0x03;                                \
                                                                              \
      dma3->source_address = ADDRESS32(io_registers, 0xD4) & 0x0FFFFFFF;      \
      dma3->dest_address   = ADDRESS32(io_registers, 0xD8) & 0x0FFFFFFF;      \
                                                                              \
...
{                                                                             \
  u8 *ws_n = memory_waitstate_n[length_type];                                 \
  u8 *ws_s = memory_waitstate_s[length_type];                                 \
